<!-- Brand Logo -->
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Hotelku</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('kamar_tipe') ?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Data Kamar Tipe
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('fasilitas') ?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Data Fasilitas
              </p>
