                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href=" <?php echo base_url('reservasi/bayar/').$value->id_reservasi ?>" class="btn btn-xs btn-warning">Bayar</a>
                        <a href=" <?php echo base_url('reservasi/hapus/').$value->id_reservasi ?>" class="btn btn-xs btn-danger">Hapus</a>
                      </td>
                    </tr>
                    <?php 
                      endforeach;
