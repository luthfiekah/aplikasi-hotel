        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('fasilitas/simpan') ?>">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Id Fasilitas</label>
                    <div class="col-sm-8">
                      <input type="number" class="form-control" name="id_fasilitas" placeholder="ID" required>
                    </div>
                    </div>
                    <div class="form-group row">
