              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('kamar/simpan') ?>">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="id_kamar" placeholder="ID Kamar" required>
                    </div>
                    </div>
                    <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" class="form-control" name="max_dewasa" placeholder="Max Dewasa" required>
                    </div>
                    </div>
                    <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Max Anak</label>
                    <div class="col-sm-8">
                      <input type="number" class="form-control" name="max_anak" placeholder="Max Anak" required>
                    </div>
                  </div>
                  <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Status Kamar</label>
                      <select class="form-control" style="width: 20%;" name="Status Kamar" required>
